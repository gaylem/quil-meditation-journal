...
const Meditate = () => {
  return (
    <div className='page-container'>
      ...
      <br />
      <p>
        The more you meditate, the less you worry about how &quot;good&quot; you are at it and the more you see that a willingness to persevere is key. And what matters more is the gift you are giving to yourself: <span className='purple'>the chance to just be, with compassion and without judgment.</span>
      </p>
      <br />
      <p>
        If you&apos;ve never meditated before, or need a little refresher, <span className='purple'>review the instructions below.</span> They will provide you with a simple way to start your practice. Additional resources are also provided below if you&apos;d like to expand your learning.
      </p>
      <br />
      <br />
      <h2>Preparation</h2>
      ...
      <ol>
        <li>
          <span className='purple'>Connect.</span> Begin by scanning from the top of your head and moving downward through your entire body, observing sensations in each part without judgment.
          <ul>
            ...
            <li>If you experience pain or discomfort, observe it and any emotions that arise because of the pain without reacting.</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>As you may have noticed, you have been gradually narrowing your focus from your surroundings to your body, then from your body to your breath, and now from the breath generally to the specific sensation around your nostrils.</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>Remind yourself that noticing your mind wandering and returning to the breath is sufficient, and over time, your mind will wander less and less.</li>
            <li>
              <span className='purple'>The goal of this phase is to strengthen your observational skills, not to eliminate your thoughts.</span>
            </li>
          </ul>
        </li>
        <br />
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>It involves repeating mantras such as &quot;May I be happy&quot; or &quot;May you be healthy&quot; and extending those wishes to yourself, loved ones, and even people you dislike. You can create mantras or find more traditional ones if you prefer.</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>Feel the sensations of your feet and observe your surroundings. Sync your breath with your steps by inhaling for a certain number of steps, and then exhaling for a certain number of steps.</li>
